...
# CANONICAL GPU bake (all 19 methods incl. the TiRex-2 WSL lane); anything that regenerates on a lighter
# engine set must write elsewhere, or it silently downgrades the artifacts the site deploys (this
# happened: a pytest run_all clobbered the then-18-method bake to the 9-method CPU lane and it shipped).
