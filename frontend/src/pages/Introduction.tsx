...
export default function Introduction() {
  ...
  return (
    <section className="page-body prose">
      ...
      <p>{es
        ? 'Cada número es trazable: los métodos pesados llevan la insignia "replay" (precalculados por el pipeline abierto, con semilla), los ligeros corren en vivo en tu navegador, y el pie de página declara la procedencia de datos y motores con sus licencias.'
