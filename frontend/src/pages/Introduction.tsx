...
export default function Introduction() {
  ...
  return (
    <section className="page-body prose">
      ...
      <p>{es
        ? 'Dos pilares con el mismo peso. ENTENDER: diez familias de diagnóstico (estacionariedad y raíces unitarias; autocorrelación e identificación Box-Jenkins; estacionalidad y espectro; filtros y descomposición adaptativa; puntos de quiebre y regímenes; volatilidad y transformaciones; distribución y complejidad; fractales y multifractales; dinámica no lineal y caos; causalidad y cointegración), cada una delegada a su implementación de referencia y horneada por caso. PRONOSTICAR: una escalera de 19 métodos, del naive estacional a TimesFM 2.5, Chronos-2 y TiRex-2 (por el carril WSL2), evaluada con un backtest de origen móvil sin fuga y un banco prequential de streaming.'
