...
\author{%
  ...
  \thanks{Preprint, 2026, version 2.1 (revised). The harness is released as the
...
coverage, the rolling weighted quantile loss (interval sharpness), and cumulative compute cost, the last of which separates a genuinely
...
be gamed independently, empirical coverage versus the nominal level, and the weighted quantile
loss~\cite{gneiting2007} for probabilistic sharpness, the sharpness component of the M4 interval
score~\cite{makridakis2020}. The harness sits behind a
...
$0.77\!\to\!0.80$; real UCI electricity raw $0.76\!\to\!0.80$); and on the honesty controls
